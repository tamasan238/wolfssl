...
namespace wolfSSL.CSharp
{
    public class wolfcrypt
    {
        ...
        */
...
#if HAVE_MLKEM
        /// <summary>
        /// Create a new MlKem key pair and initialize it with random values
        /// </summary>
        /// <param name="type">MlKem parameter set type</param>
        ...
        public static void MlKemFreeKey(IntPtr key)
        {
            IntPtr heap = IntPtr.Zero;

            if (key != IntPtr.Zero)
            {
                wc_MlKemKey_Delete(key, ref heap);
                key = IntPtr.Zero;
            }
        }

        /// <summary>
        /// Encode the MlKem/ML-KEM public key to a byte array.
        /// </summary>
        /// <param name="key">Pointer to the MlKem key structure.</param>
        ...
        /// <summary>
        /// Encode the MlKem/ML-KEM private key to a byte array.
        /// </summary>
        /// <param name="key">Pointer to the MlKem key structure.</param>
        ...
        /// <summary>
        /// Decode a MlKem public key from a byte array.
        /// </summary>
        /// <param name="key">Pointer to the MlKem key structure.</param>
        ...
        /// <summary>
        /// Decode a MlKem private key from a byte array.
        /// </summary>
        /// <param name="key">Pointer to the MlKem key structure.</param>
        ...
        /// <summary>
        /// Perform MlKem encapsulation to generate a ciphertext and shared secret
        /// </summary>
        /// <param name="key">Pointer to the MlKem key structure</param>
        ...
        /// <summary>
        /// Perform MlKem decapsulation to recover the shared secret from ciphertext
        /// </summary>
        /// <param name="key">Pointer to the MlKem key structure</param>
        ...
        public static void DilithiumFreeKey(IntPtr key)
        {
            IntPtr heap = IntPtr.Zero;

            if (key != IntPtr.Zero)
            {
                wc_dilithium_delete(key, ref heap);
                key = IntPtr.Zero;
            }
        }
